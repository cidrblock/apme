...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_VALIDATERESPONSE']._serialized_end=420
  _globals['_VALIDATOR']._serialized_start=423
  _globals['_VALIDATOR']._serialized_end=558
