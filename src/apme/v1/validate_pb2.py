...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_VALIDATERESPONSE']._serialized_end=381
  _globals['_VALIDATOR']._serialized_start=384
  _globals['_VALIDATOR']._serialized_end=519
